...
public class GetRequest04 {
    /*
    http://dummy.restapiexample.com/api/v1/employees url ine GET request i yolladigimda gelen response un
    status kodunun 200 ve content type inin "application/json"
    ve employees sayisini 24
    ve emplayee lerden birinin "Ashton Cox"
    ve gelen yaslar içinde 21,61, ve 23 degerlerinden birinin oldugunu test edin.
     */
    @Test
            public void test04(){
